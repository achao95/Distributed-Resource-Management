...
public class UserScript {
		...
		for (String line : lines) {
			...
			for (String statement : statements) {				
				...
				if (command.equalsIgnoreCase("write-request-n")) {
					...
					action = new ManagementRequest(resource_name, ManagementRequestType.ENABLE);
				} else if (command.equalsIgnoreCase("disable")) {
					action = new ManagementRequest(resource_name, ManagementRequestType.DISABLE);
	...
	public static UserScript fromFile (String filename) throws FileNotFoundException {
		...
		/*StringBuilder str = new StringBuilder();
		if (filename.equals("test1script1.txt")) {
			str.append("write-request-b Printer_0");
			str.append('\n');
			str.append("read-request-n 	Scanner_0");
			str.append('\n');
			str.append("write-release 	Printer_0");
			str.append('\n');
			str.append("read-release 	Scanner_0");
			str.append('\n');
		} else if (filename.equals("test1script2.txt")) {
			str.append("write-request-b Printer_0 | read-request-n Scanner_0");
			str.append('\n');
			str.append("write-release Printer_0 | read-release Scanner_0");
			str.append('\n');
		} else if (filename.equals("test2script.txt")) {
			str.append("disable Printer_0");
			str.append('\n');
			str.append("write-request-b Printer_0");
			str.append('\n');
			str.append("enable Printer_0");
			str.append('\n');
			str.append("write-request-b Printer_0");
			str.append('\n');
			str.append("write-release Printer_0");
			str.append("\n");
		} else if (filename.equals("test3script1.txt")) {
			str.append("write-request-b Printer_0");
			str.append('\n');
			str.append("sleep 50");
			str.append('\n');
			str.append("disable Scanner_0");
			str.append('\n');
			str.append("disable Scanner_0");
			str.append('\n');
			str.append("write-release Printer_0");
			str.append('\n');
		} else if (filename.equals("test3script2.txt")) {
			str.append("read-request-n Scanner_0");
			str.append('\n');
			str.append("sleep 100");
			str.append('\n');
			str.append("read-release Scanner_0 | write-request-b Printer_0");
			str.append('\n');
			str.append("write-release Printer_0");
			str.append('\n');
		}
